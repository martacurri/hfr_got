...
WP1 system inventory report: [Collecting and editing metadata from HFR GOT](wp1.pdf) (Curri, 2026) — station metadata, operating parameters, measured variables, QC thresholds, and data availability for the HFR-NAdr network.
